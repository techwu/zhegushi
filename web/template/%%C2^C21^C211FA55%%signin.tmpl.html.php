<?php /* Smarty version 2.6.26, created on 2013-10-09 13:52:08
         compiled from /Users/wumin/Zend/workspaces/DefaultWorkspace/gushire/template/grape/container/sign/signin.tmpl.html */ ?>
<div class="container">
	<form class="form-signin form-col" rel="form-login" action="user/ajax_logon" method="post">
		<fieldset>
			...
			<div class="form-group <?php if (! empty ( $this->_tpl_vars['error'] )): ?>has-error<?php endif; ?>">
			    ...
			    <input type="password" class="form-control on placeholder" placeholder="密码" name="pwd" >
